...
const static uint16_t NUM_TX_ENTRY_PER_CACHELINE =
    CACHELINE_SIZE / sizeof(pmem::TxEntry);
const static uint16_t NUM_BITMAP_PER_CACHELINE =
    CACHELINE_SIZE / sizeof(pmem::Bitmap);
...
constexpr static uint16_t NUM_INLINE_BITMAP =
    NUM_CL_BITMAP_IN_META * NUM_BITMAP_PER_CACHELINE;
constexpr static uint16_t NUM_INLINE_TX_ENTRY =
    NUM_CL_TX_ENTRY_IN_META * NUM_TX_ENTRY_PER_CACHELINE;
